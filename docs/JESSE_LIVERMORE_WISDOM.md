...
## 6. Position Sizing — The Probe System in Numbers

| Step | Trigger | Tranche Size |
|---|---|---|
| 1 — Initial probe | Price breaks above pivotal point | 20% of full planned position |
| 2 — First add | Price moves +1 ATR favorably from entry | +30% |
| 3 — Second add | New high after consolidation; RS strengthening | +30% |
| 4 — Final add | Volume expansion, trend acceleration | +20% |
| Exit | Price hits pre-set stop at **any step** | **Sell 100%** |

### The Capital Rules

- **Total risk per trade:** ≤ 1% of total equity (stops getting hit = 1% loss max).
- **Maximum open risk across the whole portfolio:** ≤ 5–6% at any one time.
- **Maximum sector concentration:** ≤ 25% of capital in any one sector.
- **Cash is a legitimate position.** Holding 100% cash in a bad market or uncertain period is not a failure — it's the right trade.

---

## 7. Risk : Reward Framework

- **Minimum R:R required to take any trade:** **3 : 1** — meaning you target at minimum 3× what you risk.
- **Price targets are not invented** — they are the next logical pivotal point, a measured move from the base, or a prior significant high.
- **Win rate target:** 40–50%. Livermore's edge was **not high accuracy** — it was enormously asymmetric R:R when right.
- **Expectancy formula that drives the edge:**

```
E = (Win% × Avg Win Size) − (Loss% × Avg Loss Size)

Example with Livermore's profile:
E = (45% × 4R) − (55% × 1R) = 1.8R − 0.55R = +1.25R per trade expected
```

- **At 1% risk per trade:** +1.25R means +1.25% expected return per trade taken.
...
## 10. Daily Affirmations — Read Before the Open

> Print this page. Read it aloud at 9:00 AM or 15 minutes before your market opens. Every single day.

1. **I will trade only my plan today, not my emotions.**
2. **I will take only A+ setups. If none appear, I will not trade — and that is a win.**
3. **My stop is sacred. I will honor it without negotiation, no matter what.**
4. **I will never average down. I will never add to a loser under any circumstances.**
5. **I will let my winners run. The market rewards patience, not action.**
6. **I am not here to be right. I am here to make money. These are different things.**
7. **Cash is a position. Sitting in cash is a winning trade in the right market.**
8. **I will judge today by my discipline, not by my P&L. Good process creates good outcomes over time.**
9. **The market owes me nothing. I owe the market my full respect and attention.**
10. **I trade to survive first, profit second, and build wealth third. In that order. Always.**

---

## 11. Checklists — Pre-Market, Pre-Trade, End-of-Day

### 11.1 Pre-Market Checklist (Run Every Morning)

- [ ] What is the broad market trend? (Is price above or below 50-day and 200-day MA?)
- [ ] Was yesterday a Follow-Through Day or a Distribution Day for the index?
- [ ] What are the market leaders doing? (Check your top 5 RS-ranked names)
- [ ] What are all my open positions' stops? Are they current and placed?
- [ ] Any earnings releases, Fed announcements, or macro data today?
- [ ] What is my **maximum total risk budget** for today? (e.g., 2% of total equity)
- [ ] Did I sleep adequately, eat, exercise? Am I emotionally calm and neutral?
- [ ] Is today a day I *should* be trading, or should I sit out?

### 11.2 Pre-Trade Checklist (Before Every Single Entry)

- [ ] Is the stock in a confirmed Stage 2 uptrend? (Rising price above a rising 30-week MA)
- [ ] Is it breaking out of a valid base? (4+ weeks of consolidation, volume contracting into the base)
- [ ] Is **volume ≥ 1.5× the 50-day average** on this breakout candle?
- [ ] Is the RS line at or near new all-time highs, and leading price?
- [ ] Is the broad market in an uptrend — **not** in a correction or under distribution?
- [ ] Where exactly is my **stop loss**? (Defined in price, not percentage — written down before entering)
- [ ] What is my **R:R ratio**? (Must be ≥ 3:1 to qualify)
- [ ] What is my **position size**? (Risk ≤ 1% of total equity after applying the stop distance)
- [ ] Am I entering because of my **documented plan**, or because of a **feeling / tip / fear of missing out**?
- [ ] Have I written this trade in my journal **before I click buy**?

### 11.3 End-of-Day Checklist

- [ ] Did I follow all my rules on every trade taken today? (Yes/No per trade, no ambiguity)
- [ ] Are all open-position stops in place and entered for tomorrow?
- [ ] One sentence per trade recorded in the trading journal.
- [ ] Tomorrow's watchlist drafted — start fresh with 5–10 best setups only.
- [ ] Screens off by a defined time (e.g., 6 PM). Trading ends when the market closes.

---

## 12. Top 50 Quotes — Memorize These

**On Patience & Sitting Tight**
1. *"It never was my thinking that made the big money for me. It always was my sitting."*
2. *"Men who can both be right and sit tight are uncommon."*
3. *"The market will pay you to wait."*
4. *"There is a time to go long, a time to go short, and a time to go fishing."*
5. *"The average man doesn't wish to be told that it is a bull or a bear market. What he desires is to be told specifically which particular stock to buy or sell. He wants to be given something for nothing. He does not wish to work. He doesn't even wish to have to think."*

**On Cutting Losses Immediately**
6. *"Losses never bother me after I take them. I forget them overnight. But being wrong — not taking the loss — that is what does the damage to the pocketbook and to the soul."*
7. *"A loss never troubles me after I take it."*
8. *"There is only one side of the market and it is not the bull side or the bear side, but the right side."*
9. *"It is foolhardy to make a second trade, if your first trade shows you a loss."*

**On Trend & The Tape**
10. *"Markets are never wrong — opinions often are."*
11. *"Watch the market leaders, the stocks that have led the charge upward in a bull market."*
12. *"Do not anticipate and move without market confirmation — being a little late in your trade is your insurance that you are right or wrong."*
13. *"The trend is your friend until the end when it bends."*
14. *"Successful traders always follow the line of least resistance."*

**On Pivotal Points & Breakouts**
15. *"All through time, people have basically acted and reacted the same way in the market as a result of: greed, fear, ignorance, and hope. That will never change."*
16. *"When a stock gets into a definite trend, it is astonishing how it will keep on and on."*
17. *"If a stock doesn't act right, don't touch it; because, being unable to tell precisely what is wrong, you cannot tell which way it will move."*

**On Averaging Down & Adding to Losers**
18. *"Averaging losses is the most certain road to financial ruin on Wall Street."*
19. *"Never buy a stock because it has had a big decline from its previous high."*
20. *"Of all speculative blunders, there are few greater than trying to average a losing game."*

**On Speculation & the Game**
21. *"Speculation is far too exciting. Most people who speculate hound the brokerage offices… the ticker is always on their minds. They are so engrossed with the minor ups and downs, they miss the major movements."*
22. *"All stock market mistakes wound you in two tender spots — your pocketbook and your vanity."*
23. *"The game of speculation is the most uniformly fascinating game in the world. But it is not a game for the stupid, the mentally lazy, the man of inferior emotional balance, or the get-rich-quick adventurer."*
24. *"The desire for constant action irrespective of underlying conditions is responsible for many losses in Wall Street among the professional classes."*

**On Position Sizing & Risk**
25. *"You should never invest more than you can afford to lose."*
26. *"A man must believe in himself and his judgment if he expects to make a living at this game."*

**On Psychology & Self-Mastery**
27. *"The successful trader has to fight these two deep-seated instincts. He has to reverse what you might call his natural impulses. Instead of hoping he must fear; instead of fearing he must hope."*
28. *"There is nothing like losing all you have in the world for teaching you what not to do."*
29. *"I made the mistake of not adhering rigidly to my own rules."*
30. *"I trade on my own information and follow my own methods."*

**On Tips & Outside Information**
31. *"Beware of inside information… all inside information."*
32. *"Somebody is always giving you good advice… but you have to be in the game to win."*

**On the Crowd & Human Nature**
33. *"Wall Street never changes. The pockets change, the suckers change, the stocks change, but Wall Street never changes, because human nature never changes."*
34. *"I sometimes think that speculation must be an unnatural sort of business, because the average speculator has arrayed against him his own nature."*
35. *"Every day brings its quota of fools who do foolish things at the right time."*

**On Big Moves & Big Money**
36. *"Big money is not in the individual fluctuations but in the main movements — that is, not in reading the tape but in sizing up the entire market and its trend."*
37. *"An old broker once said to me: 'If I am walking along a railroad track and I see a train coming toward me at sixty miles an hour, do I keep walking on the ties?'"*
38. *"What beat me was not having brains enough to stick to my own game."*

**On Discipline & Conviction**
39. *"Without faith in his own judgment no man can go very far in this game."*
40. *"When I am long of stocks, it is because my reading of conditions has made me bullish."*
41. *"Play the market only when all factors are in your favor. No person can play the market all the time and win."*

**On Overtrading**
42. *"There is the plain fool, who does the wrong thing at all times everywhere, but there is the Wall Street fool, who thinks he must trade all the time."*
43. *"Money is made by sitting, not trading."*

**The Highest Laws**
44. *"I never blame the market for my losses. I blame myself."*
45. *"Every man's loss is the result of his own actions."*
46. *"There is nothing new on Wall Street or in stock speculation. What has happened in the past will happen again, and again, and again."*
47. *"The market does only two things — it goes up and it goes down."*
48. *"When you know what not to do in order not to lose money, you begin to learn what to do in order to win."*
49. *"It takes a man a long time to learn all the lessons of all his mistakes."*
50. *"The game taught me the game. And it didn't spare the rod while teaching me."*

---

## 13. Chapter Highlights — Lessons from *Reminiscences of a Stock Operator*

- **Chapters 1–3 (Bucket Shops):** Repetitive, fast-feedback pattern recognition builds intuition. Livermore made $1,000 at 15 — not by being smart, but by disciplined tape-reading.
- **Chapters 4–5 (First Wall Street Failures):** Bucket-shop speed doesn't transfer to real markets. Execution delays, slippage, and position size all changed the game. He had to rebuild his method entirely.
- **Chapters 6–8 (The 1907 Panic):** The greatest opportunities come at maximum fear and dislocation. Be **liquid** before the storm. Have your plan ready before the opportunity arrives.
- **Chapters 9–12 (Cotton & Commodity Disasters):** Trading outside your proven circle of competence is a form of gambling. Stick to what you've mastered.
- **Chapters 13–15 (Pivotal Points Defined):** The foundation of the entire Livermore method. The breakout creates the line of least resistance. Waiting for the pivotal point is non-negotiable.
- **Chapters 16–18 (At the Peak):** Even in his greatest years, the discipline of the system — not brilliance or special insight — was what created and preserved results.
- **Chapters 19–24 (Discipline & Ruin):** Every single blowup in his career was caused by **violating his own rules** — not by the rules failing him. The method was sound. The man, occasionally, was not.
...
## 15. The Livermore One-Page Summary — Print This, Keep It

**ENTRY — The Pivotal Point System**
- Confirmed uptrend + valid base (4+ weeks) + breakout on ≥ 1.5× average volume
- Probe 20% → add on confirmation → max 4 tranches, each at higher price
- **Never** anticipate. Confirm. Then enter.

**EXIT — The Danger Point Rules**
- Stop set below the pivotal breakout level. **Inviolable.**
- Risk ≤ 1% of equity per trade. No exceptions.
- Trail under swing lows or the 10/20-day moving average.
- Sell half into climax strength. Trail the rest until the trend definitively breaks.

**POSITION SIZING**
- 1% max risk per trade
- 5% max open risk across the full portfolio
- 25% max in any one sector
- Cash is a position — hold it proudly in bad markets

**THE MIND — THE ONLY EDGE YOU CAN OWN**
- Plan before the open. Trade the plan. Period.
- 3 losses in a row = stop for the day
- Big loss = half-size for 2 weeks
- Process over P&L. Discipline over IQ. Always.

**THE FIVE NEVERS**
1. Never average down
2. Never enter without a pre-defined stop
3. Never trade on a tip or opinion
4. Never trade in a dull, directionless market
5. Never trade to "get even" after a loss

**THE FIVE ALWAYS**
1. Always trade with the confirmed trend
2. Always cut losses fast, at the pre-set stop
3. Always let winners run — use trailing stops, not emotions
4. Always trade market leaders, never laggards
5. Always honor your own rules — especially when it is the hardest thing to do

---

> *"The market is a device for transferring money from the impatient to the patient."*

Read this document before every trading day.
Print sections 10 and 15 — tape them to your monitor and keep them in your wallet.
